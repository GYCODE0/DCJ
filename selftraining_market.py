...
#####################################################################################
    ...
    model = models.create(args.arch, num_features=args.features,
                          dropout=args.dropout, num_classes=1041, triplet_features=0)
...
################################################################################
    ...
    #computing distmat
     #distmat = pairwise_distance(features, features,dataset0.target_train,dataset0.target_train)
    ...
    save_checkpoint({
            ...
            'epoch': epoch + 1,
    }, fpath=osp.join('./selftraining_market', 'checkpoint.pth.tar'))
    ...
    #log
    file = open('0000_market.txt','a');
    s = '\n'+'iteration'+' '+str(args.iteration)+'  '+'epoch:'+' '+str(args.epochs_newtrain)+'  '+'batchsize:'+str(args.batch_size)+'  '+'batchsize1:'+str(args.batchsize1)+'  '+'batchsize2:'+str(args.batchsize2)+'  '+'eraser:'+str(args.re)+'  '+'mAP:'+' '+str(mAP)[:6]+'  '+'r1:'+' '+str(r1)[:6]+'  '+'r5:'+' '+str(r5)[:6]+'  '+'r10:'+' '+str(r10)[:6]
    file.write(s);
    file.close();
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', type=str, default='./baseline_market/checkpoint.pth.tar', metavar='PATH')
    parser.add_argument('--evaluate', action='store_true',
                        help="evaluation only")
    parser.add_argument('--epochs', type=int, default=0)
    parser.add_argument('--epochs_newtrain', type=int, default=60)
    ...
    parser.add_argument('--logs-dir', type=str, metavar='PATH',
                        default=osp.join(working_dir, '0000_market'))
