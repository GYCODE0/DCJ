...
################################################################################
    ...
    save_checkpoint({
            ...
            'epoch': epoch + 1,
    }, fpath=osp.join('./selftraining_duke', 'checkpoint.pth.tar'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', type=str, default='./baseline_duke/checkpoint.pth.tar', metavar='PATH')
    ...
    parser.add_argument('--logs-dir', type=str, metavar='PATH',
                        default=osp.join(working_dir, '0000_duke'))
